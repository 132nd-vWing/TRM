env.info('*** MOOSE GITHUB Commit Hash ID: 2018-03-29T15:58:23.0000000Z-733b80a480c2c137c5b914ea72c3a3348c32e93d ***')
...
local self=BASE:Inherit(self,CARGO_REPRESENTABLE:New(CargoStatic,Type,Name,nil,NearRadius))
...
local self=BASE:Inherit(self,CARGO_REPORTABLE:New(Type,Name,0,ReportRadius))
