...
RedSpawnerR2A = UNIT:FindByName("REDInfantryR2A")
 ...
 local IFV_LAV25_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_LAV25_vehicle", "Range2A Target9")
 local IFV_LAV25_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_LAV25_section", "Range2A Target10")
 local IFV_BRADLEY_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_Bradley_vehicle", "Range2A Target11")
 local IFV_BRADLEY_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_Bradley_section", "Range2A Target12")
 local IFV_BMP3_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_BMP3_vehicle", "Range2A Target13")
 local IFV_BMP3_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_BMP3_section", "Range2A Target14")
 local IFV_BTR_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_BTR_vehicle", "Range2A Target15")
 local IFV_BTR_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_BTR_section", "Range2A Target16")
 local IFV_M113_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_M113_vehicle", "Range2A Target17")
 local IFV_M113_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_2: IFV_M113_section", "Range2A Target18")
 local MBT_T72_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_T72_vehicle", "Range2A Target19")
 local MBT_T72_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_T72_section", "Range2A Target20")
 local MBT_T80_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_T80_vehicle", "Range2A Target21")
 local MBT_T80_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_T80_section", "Range2A Target122")
 local MBT_ABRAMS_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_Abrams_vehicle", "Range2A Target23")
 local MBT_ABRAMS_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_Abrams_section", "Range2A Target24")
 local MBT_LEO2_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_Leo2_vehicle", "Range2A Target25")
 local MBT_LEO2_section_R2A = SPAWN:NewWithAlias("_ON_DEMAND_3: MBT_Leo2_section", "Range2A Target26")
 local MISC_SHILKA_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_Shilka_vehicle", "Range2A Target27")
 local MISC_C2_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_C2_vehicle", "Range2A Target28")
 local MISC_ARTY_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_Arty_vehicle", "Range2A Target29")
 local MISC_MLRS_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_MLRS_vehicle", "Range2A Target30")
 local MISC_SA13_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_SA-13_vehicle", "Range2A Target31")
 local MISC_SA19_vehicle_R2A = SPAWN:NewWithAlias("_ON_DEMAND_4: Misc_SA-19_vehicle", "Range2A Target32")
...
IFV_M113_vehicle_R2A:OnSpawnGroup(function(group)
group:OptionDisperseOff()end)
IFV_M113_vehicle_R2A:InitRandomizePosition(true,20,5):SpawnFromUnit(BlueSpawnerR2A)
end

 function _ON_DEMAND_2_IFV_M113_section_R2A ()
IFV_M113_section_R2A:OnSpawnGroup(function(group)
group:OptionDisperseOff()end)
IFV_M113_section_R2A:InitRandomizePosition(true,20,5):SpawnFromUnit(BlueSpawnerR2A)
end
...
Menu_Range_R2A = MENU_MISSION:New("Range 2A",Menu_Range_R2A_B)
