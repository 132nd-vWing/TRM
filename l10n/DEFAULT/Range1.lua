...
spawn_menu_T1_2 = MENU_MISSION_COMMAND:New("Set up the Range 1.2 dynamically",Menu_Range_T1,SpawnTargets_T1_2)
spawn_menu_OD = MENU_MISSION:New("On Demand Spawning",Menu_Range_T1)
