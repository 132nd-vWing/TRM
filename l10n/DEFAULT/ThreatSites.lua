...
Menu_ThreatSite_1_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 1",Menu_Threat_Options_Ranges,ThreatSite_1_threat_off)
end

function ThreatSite_1_threat_off()
ThreatSite_1:SetAIOff()
Menu_ThreatSite_1_Off:Remove()
Menu_ThreatSite_1_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 1",Menu_Threat_Options_Ranges,ThreatSite_1_threat_on)
end

function ThreatSite_2_threat_on()
ThreatSite_2:SetAIOn()
Menu_ThreatSite_2_On:Remove()
Menu_ThreatSite_2_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 2",Menu_Threat_Options_Ranges,ThreatSite_2_threat_off)
end

function ThreatSite_2_threat_off()
ThreatSite_2:SetAIOff()
Menu_ThreatSite_2_Off:Remove()
Menu_ThreatSite_2_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 2",Menu_Threat_Options_Ranges,ThreatSite_2_threat_on)
end

function ThreatSite_3_threat_on()
ThreatSite_3:SetAIOn()
Menu_ThreatSite_3_On:Remove()
Menu_ThreatSite_3_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 3",Menu_Threat_Options_Ranges,ThreatSite_3_threat_off)
end

function ThreatSite_3_threat_off()
ThreatSite_3:SetAIOff()
Menu_ThreatSite_3_Off:Remove()
Menu_ThreatSite_3_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 3",Menu_Threat_Options_Ranges,ThreatSite_3_threat_on)
end

function ThreatSite_4_threat_on()
ThreatSite_4:SetAIOn()
Menu_ThreatSite_4_On:Remove()
Menu_ThreatSite_4_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 4",Menu_Threat_Options_Ranges,ThreatSite_4_threat_off)
end

function ThreatSite_4_threat_off()
ThreatSite_4:SetAIOff()
Menu_ThreatSite_4_Off:Remove()
Menu_ThreatSite_4_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 4",Menu_Threat_Options_Ranges,ThreatSite_4_threat_on)
end
...
Menu_ThreatSite_7_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 7",Menu_Threat_Options_Ranges,ThreatSite_7_threat_off)
end

function ThreatSite_7_threat_off()
ThreatSite_7:SetAIOff()
Menu_ThreatSite_7_Off:Remove()
Menu_ThreatSite_7_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 7",Menu_Threat_Options_Ranges,ThreatSite_7_threat_on)
end

function ThreatSite_8_threat_on()
ThreatSite_8:SetAIOn()
Menu_ThreatSite_8_On:Remove()
Menu_ThreatSite_8_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 8",Menu_Threat_Options_Ranges,ThreatSite_8_threat_off)
end

function ThreatSite_8_threat_off()
ThreatSite_8:SetAIOff()
Menu_ThreatSite_8_Off:Remove()
Menu_ThreatSite_8_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 8",Menu_Threat_Options_Ranges,ThreatSite_8_threat_on)
end

function ThreatSite_9_threat_on()
ThreatSite_9:SetAIOn()
Menu_ThreatSite_9_On:Remove()
Menu_ThreatSite_9_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 9",Menu_Threat_Options_MOAs,ThreatSite_9_threat_off)
end

function ThreatSite_9_threat_off()
ThreatSite_9:SetAIOff()
Menu_ThreatSite_9_Off:Remove()
Menu_ThreatSite_9_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 9",Menu_Threat_Options_MOAs,ThreatSite_9_threat_on)
end

function ThreatSite_10_threat_on()
ThreatSite_10:SetAIOn()
Menu_ThreatSite_10_On:Remove()
Menu_ThreatSite_10_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 10",Menu_Threat_Options_MOAs,ThreatSite_10_threat_off)
end

function ThreatSite_10_threat_off()
ThreatSite_10:SetAIOff()
Menu_ThreatSite_10_Off:Remove()
Menu_ThreatSite_10_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 10",Menu_Threat_Options_MOAs,ThreatSite_10_threat_on)
end

function ThreatSite_11_threat_on()
ThreatSite_11:SetAIOn()
Menu_ThreatSite_11_On:Remove()
Menu_ThreatSite_11_Off = MENU_MISSION_COMMAND:New("Deactivate Threat Site Range 11",Menu_Threat_Options_MOAs,ThreatSite_11_threat_off)
end

function ThreatSite_11_threat_off()
ThreatSite_11:SetAIOff()
Menu_ThreatSite_11_Off:Remove()
Menu_ThreatSite_11_On = MENU_MISSION_COMMAND:New("Activate Threat Site Range 11",Menu_Threat_Options_MOAs,ThreatSite_11_threat_on)
end
